...
const palestrantes = [
  {
    ...
    descricao: 'Vai te ajudar a estruturar a lógica e o Front-End do seu projeto.',
  },
  {
    nome: 'Teletubbies',
    ...
    descricao:
      'Ela é alegre, brincalhona e cheia de energia. Tem o corpo todo amarelo e sua antena no topo da cabeça tem o formato de um espiral (uma espécie de cacho ondulado), que é a marca que a diferencia das outras.',
  },
]
...
const filtrados = computed(() => {
  ...
  return palestrantes.filter(
    (p) => p.nome.toLowerCase().includes(termo) || p.especialidade.toLowerCase().includes(termo),
  )
})
</script>
...
<template>
  <main class="page-content">
    ...
    <div class="busca-wrapper">
      <input type="text" v-model="busca" placeholder="Buscar por nome ou especialidade..." />
    </div>
